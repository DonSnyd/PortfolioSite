...
My work involves analyzing probabilistic models using algebraic tools. Most recently, that involves the log-Gamma Polymer model subject to an external field, modifying techniques like geometric RSK and the Yang-Baxter equation. If you're interested or want to talk, reach out! I go more in depth on the [research page](/PortfolioSite/research).
...
I've played the viola since I was young, and continue playing in orchestras around Rochester. In my time in Rochester, I've been an active member of the [Music Department](https://www.sas.rochester.edu/mur/) on the River Campus and participated in opportunities at Eastman.
...
I've worked on the game operations staff in the [Athletic Department](https://uofrathletics.com) at the University of Rochester since my first year. We track and collect live play-by-play statistics, run the scoreboard and clocks, and complete other administrative duties during the matches/games of the varsity athletic teams.
